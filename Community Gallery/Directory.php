...
<body>
    ...
    <div class="centerstuff">
        <div id="ehehhaw"> <!--I didn't know what to name this-->
            <form action="usergallary.php">
                <input class="forminput2" type="submit" value="Click to go to your gallary">
            </form>
        ...
        <div id="ehehhaw2">
            <!--
            <form action="communitygallery.php">
                <input class="forminput2" type="submit" value="Click to go to the community gallery">
            </form>
-->
        </div>
    </div>
